        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-card border border-border text-foreground focus:ring-2 focus:ring-primary outline-none"
              required
            />
            <input
              type="password"
              ...
              required
            />
            <button type="submit" className="w-full py-3 rounded-xl gradient-sacred text-primary-foreground font-bold text-lg">
              Entrar
            </button>
          </form>
        </div>
    ...
    <div className="min-h-screen pb-24 px-5">
      <div className="max-w-3xl mx-auto pt-8">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={triggerOracle}
                    onChange={e => setTriggerOracle(e.target.value)}
                    className="w-full px-4 py-3 rounded-xl bg-card border border-border focus:ring-2 focus:ring-primary outline-none"
                    placeholder="Ex: Ejife, Alafia..."
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    value={contentFull}
                    onChange={e => setContentFull(e.target.value)}
                    className="w-full px-4 py-3 rounded-xl bg-card border border-border focus:ring-2 focus:ring-primary outline-none min-h-[300px] font-mono text-sm resize-y"
                    placeholder="# Título do Oriki&#10;&#10;Use **negrito**, *itálico*, listas, etc.&#10;&#10;Cole seu texto completo aqui..."
                    required
                  />
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="button" onClick={() => setShowForm(false)} className="px-6 py-3 rounded-xl border border-border font-semibold">
                    Cancelar
                  </button>
                </div>
              </form>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-muted-foreground py-12">Nenhum ritual cadastrado. Clique em "Novo Ritual" para começar.</p>
        )}
      </div>
    </div>
  );
