...
-- Add net_price column
ALTER TABLE public.subscription_plans ADD COLUMN net_price NUMERIC DEFAULT NULL;

-- Update admin_get_subscription_history to use net_price
